import { useColorModeValue, Text, Button, Modal, ModalOverlay, ModalContent, ModalHeader, ModalFooter, ModalBody, ModalCloseButton, InputGroup, InputLeftElement, Input, Textarea, useToast } from '@chakra-ui/react';
        ...
        <Modal isOpen={isOpen} onClose={onClose}>
            ...
            <ModalContent rounded="xl" p={3} bg={bg} mx={3}>
                ...
                <form
                    ...
                    method="post"
                    data-netlify="true"
                    onSubmit={(e) => handleFormSubmit(e, submitSuccess, errorHandler, message, email)}
